...
public class ElementUtil{
	...
	public List<WebElement> visibilityofAllElements(By locator, Duration timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
		return wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(locator));
	}

	public void getPageLinksText(By locator, Duration timeOut) {
	...
	public String waitForTitlePresent(String titleValue, Duration timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
	...
	public boolean waitForUrl(String url, Duration timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
		return wait.until(ExpectedConditions.urlContains(url));
	}

	public Alert waitForAlertToBePresent(Duration timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
